...
export default function App() {
  ...
  const backTextureDark =
    'dark:bg-[#cc5200] dark:text-orange-50 dark:[box-shadow:inset_0_12px_28px_-18px_rgba(255,185,120,0.25),inset_0_-16px_30px_-20px_rgba(20,7,0,0.65)]';
            ...
            <div className={cardFrontClassName}>
              <div className='flex h-full flex-col justify-between'>
                ...
                <div className='space-y-5 text-sm text-white/90'>
                  ...
                  <div className='flex items-center justify-between text-[0.65rem] uppercase tracking-[0.45em] text-white/60'></div>
                </div>
              </div>
            </div>

            <div className={cardBackClassName}>
              <div className='absolute inset-x-[-18%] top-[-12%] z-0 h-[130%] w-[140] text-[#a03b00] dark:text-white/20 ' />
